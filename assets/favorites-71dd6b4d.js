import{o as n,f as o}from"./header-6cb47562.js";const r=document.querySelector(".favorites-list"),c=document.querySelector(".favorites-error"),a=document.querySelector(".favorites-categories"),l=document.querySelector(".favorites-hero");r.addEventListener("click",n);const i=JSON.parse(localStorage.getItem("favorites"));function g(){const t=i.map(e=>`<button class="favorites-btn btn-categori is-active"
