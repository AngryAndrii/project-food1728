import{o as n,f as o}from"./header-1a7af29d.js";const r=document.querySelector(".favorites-list"),c=document.querySelector(".favorites-error"),a=document.querySelector(".favorites-categories"),l=document.querySelector(".favorites-hero");document.querySelector(".nav-link-home").classList.remove("current");document.querySelector(".nav-link-fav").classList.add("current");r.addEventListener("click",n);const i=JSON.parse(localStorage.getItem("favorites"));function d(){const t=i.map(e=>`<button class="favorites-btn btn-categori is-active"
